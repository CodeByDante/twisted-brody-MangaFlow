      ...
      <div className="relative w-full h-full flex items-center justify-center px-4 sm:px-8">
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none transition-opacity duration-300 ease-out">
              <div className="w-8 h-8 rounded-full border-2 border-[#bb86fc] border-t-transparent animate-spin" />
            </div>
            <img
              src={images[currentIndex]}
              alt={`Página ${currentIndex + 1}`}
              className="max-w-full max-h-[90vh] w-auto h-auto object-contain rounded-lg shadow-2xl transition-all duration-700 ease-out hover:scale-110 opacity-0 scale-95"
              onLoad={(e) => {
